...
/* XXDelay is model specific and therefore implemented in ControllerTilt.cpp */
/* XXInitialValue is model specific and therefore implemented in ControllerTilt.cpp */
...
/* XXStopSimulation is implemented in ControllerTilt.cpp */
