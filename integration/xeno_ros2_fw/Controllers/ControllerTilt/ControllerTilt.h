...
{
	public:
		enum stateflags_ControllerTilt {initialrun, mainrun, finished};

		/**
		 * ControllerTilt constructor
		 */
		ControllerTilt(void);

		/**
		 * ControllerTilt destructor
		 */
		virtual ~ControllerTilt(void);

		/**
		 * ControllerTilt Initialization of the model and calculation of the values for the start time t
