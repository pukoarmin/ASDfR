...
/* XXDelay is model specific and therefore implemented in ControllerPan.cpp */
/* XXInitialValue is model specific and therefore implemented in ControllerPan.cpp */
...
/* XXStopSimulation is implemented in ControllerPan.cpp */
